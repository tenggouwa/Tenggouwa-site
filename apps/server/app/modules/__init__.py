...
from .agent.router import admin_router as agent_admin_router
from .agent.router import private_router as agent_private_router
from .agent.router import public_router as agent_public_router
...
from .ops.router import admin_router as ops_admin_router
